...
$ pytest --ds=hobbyhub.settings --disable-warnings -v --color=yes
================================================== test session starts ==================================================
platform win32 -- Python 3.12.3, pytest-8.3.5, pluggy-1.6.0 -- C:\Users\darre\AppData\Local\Programs\Python\Python312\python.exe
...
dashboard/tests/test_dashboard.py::test_box_form_valid_creation PASSED                                             [ 11%]
dashboard/tests/test_dashboard.py::test_box_form_auto_archive PASSED                                               [ 12%]
dashboard/tests/test_dashboard.py::test_box_form_editing PASSED                                                    [ 14%]
dashboard/tests/test_dashboard.py::test_box_form_invalid_file PASSED                                               [ 15%]
dashboard/tests/test_dashboard.py::test_create_box PASSED                                                          [ 17%]
dashboard/tests/test_dashboard.py::test_edit_box_image_update PASSED                                               [ 19%]
dashboard/tests/test_dashboard.py::test_edit_box_date_forward PASSED                                               [ 20%]
dashboard/tests/test_dashboard.py::test_user_admin_overview PASSED                                                 [ 22%]
dashboard/tests/test_dashboard.py::test_toggle_user_state PASSED                                                   [ 23%]
dashboard/tests/test_dashboard.py::test_admin_password_reset PASSED                                                [ 25%]
dashboard/tests/test_dashboard.py::test_order_status_update PASSED                                                 [ 26%]
dashboard/tests/test_dashboard.py::test_admin_cancel_subscription PASSED                                           [ 28%]
hobbyhub/tests/test_hobbyhub.py::TestMailFunctions::test_send_gift_confirmation_to_sender PASSED                   [ 30%]
hobbyhub/tests/test_hobbyhub.py::TestMailFunctions::test_send_gift_notification_to_recipient PASSED                [ 31%]
hobbyhub/tests/test_hobbyhub.py::TestMailFunctions::test_send_order_confirmation_email PASSED                      [ 33%]
hobbyhub/tests/test_hobbyhub.py::TestMailFunctions::test_send_payment_failed_email PASSED                          [ 34%]
hobbyhub/tests/test_hobbyhub.py::TestMailFunctions::test_send_subscription_confirmation_email PASSED               [ 36%]
hobbyhub/tests/test_hobbyhub.py::TestMailFunctions::test_send_upcoming_renewal_email PASSED                        [ 38%]
hobbyhub/tests/test_hobbyhub.py::TestUtilsFunctions::test_alert PASSED                                             [ 39%]
hobbyhub/tests/test_hobbyhub.py::TestUtilsFunctions::test_build_shipping_details PASSED                            [ 41%]
hobbyhub/tests/test_hobbyhub.py::TestUtilsFunctions::test_get_gift_metadata PASSED                                 [ 42%]
hobbyhub/tests/test_hobbyhub.py::TestUtilsFunctions::test_get_subscription_duration_display PASSED                 [ 44%]
hobbyhub/tests/test_hobbyhub.py::TestUtilsFunctions::test_get_subscription_status PASSED                           [ 46%]
hobbyhub/tests/test_hobbyhub.py::TestUtilsFunctions::test_get_user_default_shipping_address PASSED                 [ 47%]
home/tests/test_home.py::test_register_form_required_fields PASSED                                                 [ 49%]
home/tests/test_home.py::test_register_form_max_length PASSED                                                      [ 50%]
home/tests/test_home.py::test_register_form_invalid_email PASSED                                                   [ 52%]
home/tests/test_home.py::test_register_form_password_mismatch PASSED                                               [ 53%]
home/tests/test_home.py::test_register_form_success PASSED                                                         [ 55%]
orders/test/test_orders.py::TestStripeSubscriptionMeta::test_subscription_creation PASSED                          [ 57%]
orders/test/test_orders.py::TestStripeSubscriptionMeta::test_subscription_string_representation PASSED             [ 58%]
orders/test/test_orders.py::TestOrder::test_order_creation PASSED                                                  [ 60%]
orders/test/test_orders.py::TestPayment::test_payment_creation PASSED                                              [ 61%]
orders/test/test_orders.py::test_select_purchase_type_view PASSED                                                  [ 63%]
orders/test/test_orders.py::test_order_success_view PASSED                                                         [ 65%]
orders/test/test_orders.py::test_order_cancel_view PASSED                                                          [ 66%]
orders/test/test_orders.py::test_order_history_view PASSED                                                         [ 68%]
orders/test/test_orders.py::test_choose_shipping_address_view PASSED                                               [ 69%]
orders/test/test_orders.py::test_handle_purchase_type_view PASSED                                                  [ 71%]
orders/test/test_orders.py::test_gift_message_view PASSED                                                          [ 73%]
orders/test/test_orders.py::test_secure_cancel_subscription PASSED                                                 [ 74%]
orders/test/test_orders.py::test_handle_purchase_type_no_shipping_id PASSED                                        [ 76%]
orders/test/test_orders.py::test_choose_shipping_address_no_addresses PASSED                                       [ 77%]
orders/test/test_orders.py::test_choose_shipping_address_valid_and_invalid_ids PASSED                              [ 79%]
orders/test/test_orders.py::test_create_subscription_checkout_missing_shipping_id PASSED                           [ 80%]
orders/test/test_orders.py::test_concurrent_order_creation PASSED                                                  [ 82%]
orders/test/test_orders.py::test_secure_cancel_subscription_wrong_password PASSED                                  [ 84%]
orders/test/test_orders.py::test_gift_order_creation PASSED                                                        [ 85%]
users/tests/test_users.py::TestUsersViews::test_account_view PASSED                                                [ 87%]
users/tests/test_users.py::TestUsersViews::test_add_address PASSED                                                 [ 88%]
users/tests/test_users.py::TestUsersViews::test_edit_account PASSED                                                [ 90%]
users/tests/test_users.py::TestUsersViews::test_edit_address PASSED                                                [ 92%]
users/tests/test_users.py::TestUsersViews::test_password_reset_confirm PASSED                                      [ 93%]
users/tests/test_users.py::TestUsersViews::test_password_reset_request PASSED                                      [ 95%]
users/tests/test_users.py::TestUsersViews::test_secure_delete_account PASSED                                       [ 96%]
users/tests/test_users.py::TestUsersViews::test_secure_delete_address PASSED                                       [ 98%]
users/tests/test_users.py::TestUsersViews::test_set_default_address PASSED                                         [100%]

======================================= 63 passed, 1 warning in 79.87s (0:01:19) ======================================== 
(venv) 
darre@Anton MINGW64 ~/Code/HobbySub (admin-password-reset)