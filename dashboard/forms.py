...
Defines forms used in the admin dashboard for managing boxes, products, and users.
...
class BoxForm(forms.ModelForm):
    ...
    UK and ISO date formats. Materialize-compatible widgets are used for styling.
    """
    ...
    class Meta:
        model = Box
        fields = ['name','description','image','shipping_date','is_archived']
        widgets = {
