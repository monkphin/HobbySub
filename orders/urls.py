...
Includes routes for one-off orders, subscriptions, order history, and checkout
outcomes.
"""
# Django imports
...
urlpatterns = [
    ...
    path(
        'purchase/<str:plan>/',
        handle_purchase_type,
        name='handle_purchase_type'
    ),
    path('gift/message/<str:plan>/', gift_message, name='gift_message'),

    # Subscription Cancellation
    path(
        'secure_cancel_subscription/',
        secure_cancel_subscription, name='secure_cancel_subscription'
    ),
    ...
    path(
        'shipping/select/<str:plan>/',
        views.choose_shipping_address,
        name='choose_shipping_address'
    ),
]
