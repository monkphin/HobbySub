...
urlpatterns = [
        ...
        path('secure_delete_account/', secure_delete_account, name='secure_delete_account'),
        ...
        path('secure_delete_address/<int:address_id>/', secure_delete_address, name='secure_delete_address'),
